...
class BerandaDisplay extends StatelessWidget {
  Categories categories = Categories();

  BerandaDisplay(this.categories, {Key? key}) : super(key: key);
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        getC.listFavorite.contains(categories)
                            ? Icons.favorite
                      ...
                      InkWell(
                        onTap: () => getC.addFavorite(categories),
                        child: Text(
                          "Add to favorite",
                          style: TextStyle(
                              fontSize: 12,
